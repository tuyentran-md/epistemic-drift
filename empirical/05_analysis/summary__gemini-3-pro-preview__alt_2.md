...
- **n_topics:** 4
- **mean:** 0.40833619202848853
- **ci_95:** (0.1206354924401923, 0.6960368916167848)
- **t_stat:** 0.624475792240739
- **p_one_tailed:** 0.2882919181200413
...
- **n_topics:** 4
- **mean:** 0.5793422733077905
- **ci_95:** (0.1759259259259259, 0.9827586206896552)
- **t_stat:** 1.6277324180318968
- **p_one_tailed:** 0.10103170277758097
- **passes_bonferroni:** False
...
- **mean_ratio:** 0.7087188185712594

### H4 — V-score < 6.0 — ❌ does not pass Bonferroni

- **metric:** Per-topic mean V-score (0-8 continuous)
- **n_topics:** 4
- **mean:** 7.8845238095238095
- **ci_95:** (7.678571428571429, 8.0)
- **t_stat:** 18.00608355958097
- **p_one_tailed:** 0.9998131979480122
- **passes_bonferroni:** False
...
- **NEUTRAL** (n=2): mean div = 0.983, 95%CI (0.9655172413793104, 1.0), max 1.000
- **REFUTES** (n=1): mean div = 0.185, 95%CI (None, None), max 0.185
- **SUPPORTS** (n=1): mean div = 0.167, 95%CI (None, None), max 0.167


## Drop-rate audit (≥5% threshold)

- T05: 27/30 valid (drop rate 10.0%) — FLAGGED
...
topic_id  n  p_supports  p_neutral  p_refutes  entropy_bits  entropy_bits_mm  k_observed truth_direction  truth_divergence_rate
     ...
     T05 27    0.185185   0.000000   0.814815      0.691290         0.718006           2         REFUTES               0.185185
     T10 30    0.833333   0.000000   0.166667      0.650022         0.674067           2        SUPPORTS               0.166667
     T12 29    0.965517   0.034483   0.000000      0.216397         0.241271           2         NEUTRAL               0.965517
```
...
topic_id source  n  mean_v_score  max_v_score  pct_valid_all_8  pct_pass_v1  pct_pass_v2  pct_pass_v3  pct_pass_v4  pct_pass_v5  pct_pass_v6  pct_pass_v7  pct_pass_v8
     ...
     T03     ai 30      8.000000            8        96.666667   100.000000   100.000000   100.000000   100.000000   100.000000   100.000000   100.000000   100.000000
     ...
     T05     ai 30      7.571429            8        80.000000    88.888889    96.296296    92.857143    96.428571    96.428571    96.428571   100.000000    96.428571
     ...
     T10     ai 30      7.966667            8        96.666667    96.666667   100.000000   100.000000   100.000000   100.000000   100.000000   100.000000   100.000000
     ...
     T12     ai 30      8.000000            8        96.666667   100.000000   100.000000   100.000000   100.000000   100.000000   100.000000   100.000000   100.000000
